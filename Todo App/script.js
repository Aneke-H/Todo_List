// Creating containers to store values from the user!
...
// function to submit username to the local storage
submitusername = () => {
  localStorage.setItem("name", username.value);
};

// function to get username from the local storage
getusername = () => {
...
formtodo.addEventListener("submit", (e) => {
  alert("Task added! click \"View All Task\" to see schedule!");
  e.preventDefault();
  let newtodo = [];
  let fd = new FormData(formtodo);
  let obj = Object.fromEntries(fd);
